...
// To add a new icon, add a new function here and add it to components in social-icons/SocialIcon.tsx
...
export function Blank(svgProps: SVGProps<SVGSVGElement>) {
  return <svg className="h-6 w-6" {...svgProps} />
}
